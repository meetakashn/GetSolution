...
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number N in the form of string, the task is to check if the number is divisible by 5.&nbsp;</span></p>
